...
>This is a very large area with LOTS of links to tutorials, articles, threads… and varied stuff. I recently sort ordered this alphabetically and with better groups. Take a look to the TABLE OF CONTENTS, and also: use the SEARCH field — it’s very fast!
...
[20 Essential Tools │ Creating an Animated Film in Blender](https://www.youtube.com/watch?v=5pt6ph0W0wE) - Viewport Framing - Isolating Objects - Viewer Node - Viewport Focal Length - 3D Cursor - Select by Shortest Path - Correct Face Attributes - Ray Visibility - Lighting Nodes - Online Manual - Linking - Camera Shakify - Noise Modifiers - Select Similar - Randomising - Delta Transform - IK Constraints - FaceIt - Node Wrangler - First Person
...
[Blender Secrets e-Book](https://blender-secrets-school.teachable.com/courses/enrolled/2096727) - *MINE!* - ["Just updated my E-book, it's finally 2000+ pages.](https://x.com/janvandenhemel/status/1808117437977530630?s=12)

[Blender crashes at startup? Delete the default startup.blend file! - YouTube](https://www.youtube.com/watch?v=1_G9AYh4v0g)

[Demo Files — blender.org](https://www.blender.org/download/demo-files/) - Lots of Assets ready to download and test - *FABULOUS*
...
[HBitproject](https://www.youtube.com/@hbitproject/videos) - Making of modeling classic architecture. Example: [How to use instances the right way - YouTube](https://www.youtube.com/watch?v=SDkkQvWzg7Y&t=36s)
...
[Macro Photorealism in Blender](https://www.youtube.com/watch?v=p-TEYeXQqDU) - Learn how I created this realistic macro animation in 5 minutes - I cover photogrammetry techniques, optimizing geometry, setting up adaptive displacement in Blender, adding extra detail, lighting tips, procedural animation for the ant, and general beginner friendly tips for more realistic renders. In the end I cover the final step to really push these macro renders to the next level.
...
[Q2 2024](https://ilyassel.notion.site/1ea8f5a54f0345538ddad56078d617da?v=b91189c3cbe74a86811bae78a3a1e520) - Tutorial repository - “I watched 3000h of tutorials and sorted them for you (WIP)

[Ryan King Art - YouTube](https://www.youtube.com/@RyanKingArt/playlists) - Many tutorials. Making simple renders, but to the point (discovered by tuto about transparency and glass with EEVEE in 4.2).
...
[World Building in Blender - Ian Hubert](https://www.youtube.com/watch?v=whPWKecazgM) - The master, the Wizard, the Legend!
...
[Playlist](https://www.youtube.com/@christopher3d475/playlists) - Fantastic tutorials. Probably the best for general Blender. A great guy with really in depth analysis.

[A simple scene for total Blender beginners](https://www.youtube.com/watch?v=-w2iyKtFLHg)

[Connect two objects using the Data Transfer modifier](https://www.youtube.com/watch?v=Eu9abP0LIb8)

[Exciting Render Updates in Blender 4.0!](https://www.youtube.com/watch?v=iunLnqE6mlw)

[Geometry nodes! Create product variations easily, Part 2](https://www.youtube.com/watch?v=iebqyp6mG-k)

[Parenting doesn't have to be tough! Duplicating groups of objects in Blender](https://www.youtube.com/watch?v=bMbBtcLmrmQ)

[Rotate Rotation node, a second way to align your scatter to a surface and randomize it!](https://www.youtube.com/watch?v=sDA9GwPDt6g)

[Sculpt & Scatter: Nature Scene with Geometry Nodes (Part 1) - YouTube](https://www.youtube.com/watch?v=fKmHsMx_E2I)

[Using Blender's Curve Pen Tool](https://www.youtube.com/watch?v=APxkUd7OAAk)

And much, much more great tutorials from this guy!

### Piotr Kryński

[ArtStation - Piotr Krynski](https://www.artstation.com/krynski) - A great master from Poland for Concept Art using Blender & Photoshop.

- [Piotr Krynski - YouTube](https://www.youtube.com/@piotr.krynski/videos)

- [Concept Art for Games & Movies in Blender + BLEND FILES](https://krynski.gumroad.com/l/gafohw) - *$80* - 10h of narrated content + another bonus 3h of narrated content + BLEND SCENES

- [Efficient Environment Design for Blender](https://krynski.gumroad.com/l/cgxjqg?layout=profile) - *$60* - Everything about creating environments in Blender - 10 hours of narrated content, going through the whole process, from sketching out comps and ideas, to creating assets/texturing, mixing in scans, to building (and optimizing!) huge and detailed scenes in Blender, and wrapping it up at the end with Blender Real-Time Compositor (for post processing)

### Ian Mcglasham

[Ian McGlasham - YouTube](https://www.youtube.com/@ianmcglasham)

Great techniques, tips and tricks from a veteran profesional. A great “courses” with lots of videos with *fantastic modeling and topology* techniques, tips and tricks. Even if you are an experienced modeler. And not only for texts!!!
...
[Geometry Nodes from Scratch](https://studio.blender.org/training/geometry-nodes-from-scratch/) - Blender Studio - *DONE*

### Ducky 3D

[YouTube](https://www.youtube.com/channel/UCuNhGhbemBkdflZ1FGJ0lUQ) - Recomended by Víctor Feliz - Not really such advanced…

- [Abstract Sci-Fi Animation in Blender 3D - YouTube](https://www.youtube.com/watch?v=1s3gqJ-gj1A) - Downloaded - *DONE* - Meh… see if I can extract something, more procedural

- [Build a Simple Network in Geometry Nodes (Blender Abstract tutorial) - YouTube](https://www.youtube.com/watch?v=vcESjx01DdA) Downloaded - *DONE*)

- [Sci-Fi Environment Animation in Blender & Eevee - YouTube](https://www.youtube.com/watch?v=O8kAFhSqFdM) - Downloaded - *DONE*

- [The BEST Way To Learn Blender in 2023!! - YouTube](https://www.youtube.com/watch?v=8K4AShjq-MU) - Interesting tips on how to learn, for free and paying
...
Another master on GN, with the most beautiful videos, by far.

[harry blends - YouTube](https://www.youtube.com/@harryblends) - *VERY GOOD* - SEE ALL - About Blender in general, and especially Geometry Nodes. Analysis of the new nodes in recent versions

- [A guide to attributes & fields - blender geometry nodes](https://www.youtube.com/watch?v=a-4oCHe-hDE)

- [Actually animate with geometry nodes](https://www.youtube.com/watch?v=rGmMCpmL5vs)

- [An animated guide to the Random Value geometry node in Blender](https://www.youtube.com/watch?v=Ft4kEGyOVC0)

- [Node shortcuts & the geometry node editor](https://www.youtube.com/watch?v=R8B7Cen8FTI)

- [Simulate Your Grease Pencil with Geometry Nodes](https://www.youtube.com/watch?v=bZ0JU-DSWJs)

### Ilir Beqiri

A great and generous master - Already knew this guy from the C4D times…

[Ilir Beqiri Tutorials](https://www.youtube.com/playlist?list=PLQd_Fe2Z7cpUeW-WFaBXY1qcC3Q9rLq5n) - Mainly on Geometry Nodes - YouTube List

- [3D Text - Custom Extruded Profile with Geometry Nodes](https://www.youtube.com/watch?v=elAE2YNOb0I)

- [Creative Coding - Motion Design With Geometry Nodes](https://ilirbeqiri.gumroad.com/l/grrxx) - Scene - *$3* - *MINE*

- [Creative Coding - Motion Graphics With Geometry Nodes - YouTube](https://www.youtube.com/watch?v=xwqQ0bRn0ZE)

- [Creative Coding - Torus Knot + Text Animation With Geometry Nodes - YouTube](https://www.youtube.com/watch?v=IA9QPcZfGsg)

- [How To Render Curves And Edges As Grease Pencil Strokes - Geometry Nodes](https://www.youtube.com/watch?v=6Tl7L4Q7XXk) - Downloaded

- [How To Trim Cyclic Splines In Blender Geometry Nodes](https://ilirbeqiri.gumroad.com/l/usqpj) - Downloaded, gratis - Wonderful: Animating closed splines

- [Numeric Attribute Visualizer in Geometry Nodes](https://ilirbeqiri.gumroad.com/l/xxjuix) - Scene - *$5* - *MINE*

- [Torus Knot + Text Animation](https://ilirbeqiri.gumroad.com/l/pcnpdx) - Scene - *$3* - *MINE*
...
[GeometryNodes – Entagma](https://entagma.com/tag/geometrynodes/) - Good, but complex

[Procedural Crystal Generator](https://www.youtube.com/watch?v=QiFyq1YvrPQ) - With detailed geometry with internal crystal structures and then use a dispersion shader in Cycles. Interesting also for the Better Crystal Shader creation

### Polyfjord

[Making a Procedural Trail Simulation in Blender 4.4](https://www.youtube.com/watch?v=KrCdv9sit_o) - Procedural trail effect using Geometry Nodes in Blender 4.4! We'll be animating an object using our mouse cursor and capturing the movement in real-time using auto-keying!

[3D tracking will never be the same for me again…](https://www.youtube.com/watch?v=xx85eyN1Xc0) - How to use the tools to create a perfectly tracked 3D environment using your smartphone camera, but also shares links to the (free) tools he used, including a script he wrote, which you can download and use 100% free

### CGMatter

[CGMatter](https://www.youtube.com/@CGMatter/videos) - CGMatter teaches you blender, computer graphics, and stuff

- [All models can be 1 face](https://www.youtube.com/watch?v=Cxr0neZ3Psg&t=253s)

- [Blender 4.5 Blending objects together](https://www.youtube.com/watch?v=x9MvRFuFnus&t=23s)

- [HDRIs are domes, not spheres](https://www.youtube.com/watch?v=rkPbEVHidlk)

- [Here is the powerful curvature formula](https://www.youtube.com/watch?v=Qp9ASTNJ_6o)

- [I solved Origami](https://www.youtube.com/watch?v=BNZAFl4HdzU)
...
[Create Houdini Like Flowers in Blender Tutorial (cloth sim)](https://www.youtube.com/watch?v=XS3JpWs9sIg)

[Houdini Like Plant Growth in Blender Tutorial (Geo Nodes)](https://www.youtube.com/watch?v=-1Ehl-q6x44)

[Make Blooming Roses in Blender Geo Nodes](https://www.youtube.com/watch?v=H6CjBimRXUQ)

### Viscous Realm
[YouTube Channel](https://www.youtube.com/@viscousrealm) (has a lot of short videos, quite famous, check them out further)

- [Isometric room animation](https://www.youtube.com/watch?v=QIBJQHQor68) - Tutorial and link to download scene *(interesting to recreate it in the course)*

- [Satisfying animation in blender](https://www.youtube.com/watch?v=qYQqS4Lrhoc) - we will take advantage of the face normals *(interesting to recreate it in the course)*

### Cartesian Caramel

[Cartesian Caramel - YouTube](https://www.youtube.com/@CartesianCaramel/playlists) - About Geometry Nodes and also about Shader Nodes - [Lego Set Assembly (Blender 3.5 Effect)](https://www.youtube.com/watch?v=UzocW9RtOOQ) - DOWNLOADED tutorial & scene - *TO DO*

### Yesway

[Yesway Channel](https://www.youtube.com/@yesway.studio/videos) - Great and nice tutorial videos, not extremely complex, more “simple things”, but very well presented.

- [Make index node useful](https://www.youtube.com/watch?v=CrsAfgfmgzY) - How to make the Index Node actually useful in Blender Geometry Nodes! I’ll show you how to control scaling, create smooth animations, and reorder instances easily

### How to create, save and reuse our Custom Nodes

[Blender Secrets - Using Node Groups with the Asset Browser](https://www.youtube.com/watch?v=hKZLlCZbDnI)

[How To Use Asset Library & Custom Group in Blender Tutorial](https://www.youtube.com/watch?v=JQZmWrjhN2I)

[How to Make a Geometry Node Asset Library - Blender 3.6](https://www.youtube.com/watch?v=zrj2A28W-ek)

[Make your own custom modifiers and tools in Blender 4.0!](https://www.youtube.com/watch?v=Byp1dC0dRPo)

[You CAN put Geometry Nodes into the Asset Browser](https://www.youtube.com/watch?v=v9D-gQ9eb5A)

### Weak… Meh…

[CURSO de GEOMETRY NODES en Blender - Introducción a Geometry Nodes - YouTube](https://www.youtube.com/watch?v=ZB--TW96e48) *(español, hecho… flojito)*

[EVERY Node in Geometry Nodes pt.3 | Blender 3.6 - YouTube](https://www.youtube.com/watch?v=_GOD1F-hWRM) *(DOWNLOADED - Somewhat incomplete, scattered)*

[Every Node in Blender Geometry Nodes | Geometry pt.1 - YouTube](https://www.youtube.com/watch?v=t3gm0aWJgMA) *(DOWNLOADED - Somewhat incomplete, scattered)*

[Every Node in Geometry Nodes pt.2 | Blender 3.5 - YouTube](https://www.youtube.com/watch?v=p8H8hzW_iz4) *(DOWNLOADED - Somewhat incomplete, scattered)*

[I wish I knew this before using Geometry Nodes (Blender) - YouTube](https://www.youtube.com/watch?v=VlSs430PAeU) *(DOWNLOADED - Poor)*

### Specifically about Math Node

[Math Node - Blender 4.1 Manual](https://docs.blender.org/manual/en/latest/modeling/geometry_nodes/utilities/math/math.html) - All Math nodes explained

- Some examples:

	- [Greater Than - YouTube](https://www.youtube.com/watch?v=16hJwagAmqE&list=PLIp56AMvnndlaDLxNQPJc2qK_vE8QEuqX&index=2)

	- [Modulo - YouTube](https://www.youtube.com/watch?v=Min8ZB6uivk)

	- [Ping Pong - YouTube](https://www.youtube.com/watch?v=9y0HHYD7Lxo&list=PLIp56AMvnndlaDLxNQPJc2qK_vE8QEuqX&index=3)

	- [Dot Product - YouTube](https://www.youtube.com/watch?v=EuWYn2rfSyk&list=PLIp56AMvnndlaDLxNQPJc2qK_vE8QEuqX&index=4)
...
[Brute force approach to fine jewelry design — Blender Conference 2024](https://www.youtube.com/watch?v=3urTyFWUb1o)
...
[Check Out a "Disgustingly Satisfying" Blender-Made Jiggle Deformer](https://80.lv/articles/disgustingly-satisfying-jiggle-deformer-made-with-geometry-nodes/) - Interesting procedural setups, with screenshots of the nodes
...
[Create a Handy Circular Array Node with Blender Geometry Nodes](https://www.youtube.com/watch?v=TFm65INaT8Q) - *Interesting to recreate it in the course. Maybe it can be updated*
...
[Geometry Nodes for profesional Jewelry design](https://www.youtube.com/watch?v=CWoCd-WhIsw) - 22m 32s Tutorial
...
[Gizmos // Blender 4.3 Tutorial](https://www.youtube.com/watch?v=iG8py8ggHB0) - How to create our own “better primitives” with the new **gizmos** and GN-Tools in Blender 4.3
...
[Make tracks around objects in seconds](https://www.youtube.com/watch?v=nuJukI1SM00) - With the use of the convex hull feature its easy to make tracks follow a wheel set
...
[Master Procedural Grass Creation - Blender 4.2 Tutorial - YouTube](https://www.youtube.com/watch?v=lbv-qpubGFk) - *Could be nice as an exercise for my course. Much more realistic grass*
...
[Open Class - YouTube](https://www.youtube.com/@BlenderClass) - About Blender in general, and especially Geometry Nodes, with 218 videos - Metaballs Facts
...
[Procedural Growing Neuron Fractal for Blender (tutorial)](https://www.youtube.com/watch?v=nXCSMO4iioA) - Free - [Node](https://straycreations.gumroad.com/l/neuronfractal) - *2 EUR*
...
[Quickly select any corner in a rectangle to round and keep it procedural](https://x.com/ilirbeqiri/status/1846503342014423182?s=12) - See the answers, which simplify the process. *DO IT - And recreate in the course*
...
[Sanctus - Blender Procedural](https://www.youtube.com/@Sanctus_ES/videos) - Tutoriales en español
...
[Stray Creations](https://www.youtube.com/@StrayCreations) - Tutorials, tools & Projects -[10 Geometry Nodes HACKS in Blender (+ free download) ](https://www.youtube.com/watch?v=CN2p3tNN0eU) - DOWNLOADED - Projects: [10 Geometry Node HACKS - Project File](https://straycreations.gumroad.com/l/geonodehacks1)
...
[Tips, design-patterns and strategies for clean and performant geometry-nodes setups, drawing inspiration from programming best practices](https://x.com/5agado/status/1820063292879986721?s=12) - Twitter thread
...
[Using matrix Nodes x Blender 4.2](https://www.youtube.com/watch?v=Dl4iCrksryM) - To create a blooming flower

[Vector math is EASY when you SEE it with Blender and Geometry Nodes](https://www.youtube.com/watch?v=0dZUAh4fFfM) - What vectors are, why they’re so crucial, and how to use the most important vector math operations in a visual and intuitive way
...
[Blender Packaging Tutorial: 2 Label UV Mapping](https://www.youtube.com/watch?v=6S02ayCEAsw)

[Blender's "Follow Active Quads" UV Mapping Feature](https://www.youtube.com/watch?v=SgVrp_zpqYQ)

[Create metallic toothpaste packaging, Part 1: Modeling and UV mapping](https://www.youtube.com/watch?v=o_ZrdjHIY4M&t=1404s)

[Dieline to 3D, part 2. UV unwrapping and initial folding tutorial](https://www.youtube.com/watch?v=Tuu_POR8Do0)

[Mirror UVs Quick Tip](https://www.youtube.com/watch?v=W0mzkCdU5C4)

[PART 4. UV map the seat cushion of a mid-century modern chair](https://www.youtube.com/watch?v=eTnErh6p6Nc)

[Shampoo Bottle Part 3, UV mapping, texturing, lighting, & rendering](https://www.youtube.com/watch?v=LFFvBn2NaG0)
...
[Amazingly EASY Way To Rig Characters in Blender 4.1 - YouTube](https://www.youtube.com/watch?v=jIwrswJEFBQ) (a “complete course” on rigging in just a few minutes) - *Downloaded*

[Animate Wings The Easy Way](https://www.youtube.com/watch?v=UjlgFjx5nNU) - how to create a simple wing rig which is easily controlled with just ONE master controller. *Related* (and answer with tip to fix rotation problem): [The reason why the bone rotates when you map it to the scale is radians, so 1 = 57°, pi = 180° etc.](https://x.com/lukaswestner/status/1873345465682735332)

[Beginners Guide to Rigging](https://www.youtube.com/playlist?list=PLL3OEv6vd5VCrqZiupP2m68qSWHYAjoiW) - 6 part tutorial series by Dikko
...
[Completely Rigging A Character (5 MINUTES!)](https://www.youtube.com/watch?v=X590IZeyT1s) - *Downloaded*

[DemNikoArt - YouTube](https://www.youtube.com/DemNikoArt) - Tutorials on mechanical rigging. EXAMPLE: [Mechanical Rigging - A Blender Tutorial - YouTube](https://www.youtube.com/watch?v=nyC57_HN6B0) - How to set up a rather complex rig for a robot hand

[Hardsurface rigging](https://www.youtube.com/watch?v=cvaDvtRH2E0&list=PLoY2_caCahgj55qaoDKa7-zmH6X-BkM5j) - Several very interesting tutorials on hard-surface rigs. Some with links to UNRIGGED scenes to download and practice.

[How can you use bones to animate buttons on 3D models](https://www.instagram.com/polyzone.official/reel/DBYquSAAACK/) - Short video on Instagram, can be very useful

[How to Quickly Rig IK FK in Blender (For Beginners)](https://www.youtube.com/watch?v=xEnu_EsnzjI) - *Downloaded*

[I animated the PIXAR Lamp - A Blender rigging tutorial](https://www.youtube.com/watch?v=Xw7QGARte34) - How to rig the Pixar Lamp with a few IK rigs in Blender - An exercise for understanding mechanical rigging

[Kryonic Art](https://kryonicart.gumroad.com/) - Scenes with rigging examples, ready to use and above all to learn (DOWNLOADED)

[Let's Learn Blender!: Character Rigging 101 (Armatures, Bones, & IK)](https://www.youtube.com/watch?v=iZBLtooU2Cs) - *Downloaded*

[Level Pixel Level - YouTube](https://www.youtube.com/@LevelPixelLevel) - Fantastic tutorials on mechanical riggings. EXAMPLE: [Level Pixel Level](https://levelpixellevel.gumroad.com/) - Files with free examples
...
[Rich Stubbs Animation](https://www.youtube.com/@richstubbsanimation) - Lots of GREAT tutorials on rigging here. Visit also the shop with free assets: [Buy Rich a Coffee](https://ko-fi.com/richstubbsanimation/shop)

[Rigging isn't Scary](https://www.youtube.com/watch?v=zjeql4zppsg) - This is a good walkthrough of rigging in Blender from easier to more advanced and its free - [FULL LIST](https://www.youtube.com/playlist?list=PLdcL5aF8ZcJsSWrFwmLsQvCIKisuyyMnU)

[Rigify - Blender 4.4 Manual](https://docs.blender.org/manual/en/latest/addons/rigging/rigify/index.html) - For the moment I prefer to have it **disabled** and do all manually. Rigify helps automate the creation of character rigs. It is based around a building-block approach, where you build complete rigs out of smaller rig parts (e.g. arms, legs, spines, fingers…)
...
[3 Point Lighting, Inverse Square Falloff, Gamma Correction, Filmic and More!](https://www.youtube.com/watch?v=Bgm0Atx2YJ4)

[3 Tips for better renderings in Blender 3.4](https://www.youtube.com/watch?v=Dpg0fcqIKhg)
...
[About Blender's Specular Channel](https://www.youtube.com/watch?v=b0_CZ7dI1yE)
...
[An energy conserving technology preview](https://www.youtube.com/watch?v=d3HziipZ7zo)
...
[Anisotropy in Blender 4.3](https://www.youtube.com/watch?v=7HeDHWsotkk)

[Array Lights in Blender - Simple Trick](https://www.youtube.com/shorts/ZObhhlkRcOU)

[BLENDER BEGINNINGS Episodio 3: Diseño - Pestañas de propiedades](https://www.youtube.com/watch?v=N69Qr_Bd_oo) - [HERE ](https://www.youtube.com/watch?v=N69Qr_Bd_oo&t=2080s)explains what to use the TEXTURES tab for (it is currently very little used, as mentioned [HERE](https://blender.stackexchange.com/questions/222519/i-dont-know-when-i-should-use-texture-properties-tab))

[Better Fur, Hair, and Anime shaders](https://www.youtube.com/watch?v=DptPx8sY7Bg)

[Better light sampling, the Light Tree!](https://www.youtube.com/watch?v=d5RbFRzJZT8)
...
[Blender 3.2 Shadow Caustics & how to get raytraced caustics](https://www.youtube.com/watch?v=QmH8YSSN0W4)

[Blender Insight](https://www.youtube.com/@jtornhill/videos) - To learn about materials, patterns and shaders - By Joakim Tornhill, creator of [PatternMaker](https://blendermarket.com/products/patternmaker) - Kind of mini Substance Designer
...
[Cartesian Caramel](https://www.youtube.com/@CartesianCaramel/playlists) - About Geometry Nodes and also about Shader Nodes

[Caustics & Filter Glossy in Blender 3.1](https://www.youtube.com/watch?v=FS5rgQ8SxRY)
...
[Complete Guide of Hand Painting Game Assets in Blender with Ucupaint](https://www.youtube.com/watch?v=5nwoGU_ZmhY)
...
[Creating a sparking constellations with shader nodes](https://www.youtube.com/watch?v=qYr6y8IVuyk) - 20 min video tutorial by *Celestial Maze*

[Cycles is better than you think... by Turpal Alex Saytiev — Blender Conference 2024](https://www.youtube.com/watch?v=auTKRan7oPk) - *Watch it ASAP*

[Demystifying Blender's Specular Channel! How Specular relates to the Roughness channel](https://www.youtube.com/watch?v=yJHSd6FCLig)
...
[Frame Shifting in Blender for better architectural renderings](https://www.youtube.com/watch?v=EqwPhzrJ0ic)
[Blender 5.0 has ACES support, kind of...](https://www.youtube.com/watch?v=9mMtZWs6sto)
[How to determine specific anodized metallic colors in Blender 5.0. - YouTube](https://www.youtube.com/watch?v=K5okG0feNyQ)

[Free Mini-course on Color Grading With Render Raw](https://www.creativeshrimp.com/free-course-color-grading-render-raw) - Course Free - [Render Raw - Color Correction & Effect](https://superhivemarket.com/products/render-raw) - Add-On *$25*

[Get proper energy conserving materials in Cycles](https://www.youtube.com/watch?v=kgORQ5tMe2I)
...
[How I Made a 2D-Looking Cat Animation Scene in Blender!](https://www.youtube.com/watch?v=iNeRyRSO-kU)

[How Ian Hubert Hacked VFX (and you can too!)](https://www.youtube.com/watch?v=w6YPbidAAzQ)
...
[I wish I knew this before using Image Textures (Blender)](https://www.youtube.com/watch?v=x_guNosYPVw) - Downloaded, *poor*, too long for the little it explains… already seen
...
[Nested Dielectrics, the key to better fluid filled objects](https://www.youtube.com/watch?v=fJrHq9Z2iig)

[Normal maps - DirectX vs OpenGL: what's the difference?](https://x.com/cgcookie/status/1923022306143567948?s=61)

[Path Guiding in Blender 3.4, Better Caustics and Less Noise](https://www.youtube.com/watch?v=Rr84CUTjuz4)

[Prevent color problems when saving in PNG or JPEG2000 from Blender](https://www.youtube.com/watch?v=0Bo3IED7KMQ)

[Procedural Dynamic Paint](https://www.youtube.com/watch?v=iCRYitOrYVY) - Tutorial and showcasing the new features and improvements introduced in [Procedural Dynamic Paint v2.1](https://3dsinghvfx.gumroad.com/l/procedural-dynamic-paint) for GN

[Procedural Shading: Fundamentals and Beyond](https://studio.blender.org/training/procedural-shading/)

[Quick-Materials](https://www.youtube.com/watch?v=Pvi7GE2JYq0&list=PLubXlzgjs-u5Fqnzq0-rJhxBOczHwIqaB) - Short videos by *Celestial Maze* with EXTREMELY useful tips on creating shapes like Substance Designer style
...
[Remake BLOOM menu in Blender 4.2](https://www.youtube.com/watch?v=W6Yl5Cwq5XE)
...
[Sculpt & Scatter: Nature Scene with Geometry Nodes (Part 2) - YouTube](https://www.youtube.com/watch?v=SGqN9nLLBS8)
...
[Specular Reflections & Variable Roughness](https://www.youtube.com/watch?v=P--xS0xXhHY)

[Specularity and Roughness, Part 2. Dealing with excessively strong reflections](https://www.youtube.com/watch?v=5PaMxFa9SUM)

[Surface Imperfections Right | Vray, Cycles, Arnold…](https://www.youtube.com/watch?v=OW4L0vdo_e4) - How to improve the "Roughness variation" workflow to add surface imperfection by taking inspiration from real phenomenons - [Original thread in X with some ideas about how to transfer this to Blender](https://x.com/PrismalDesign/status/1990710691402297388)
...
[This Blender Shader is the Secret to Magical 3D Art](https://www.youtube.com/watch?v=mQPFjzAgGQo) - Extremely good to have a good understanding of the whole Shader Node Tree
...
[Using Anisotropic Reflections in Blender](https://www.youtube.com/watch?v=M6tY53LlzSo)

[Using Blender like Substance Designer](https://www.youtube.com/watch?v=YsXe11YA7AM)
...
### Blender hair full walkthrough

[YouTube](https://www.youtube.com/watch?v=WJbAYCx2dXo&list=PLVn1U4WzCN31gIRUFf5fCoy4z-pyZydJM) - LIST WITH 5 VIDEOS - Includes link to free Gumroad project files:

1. [Mesh preparation and guide curves](https://www.youtube.com/watch?v=WJbAYCx2dXo)

2. [Initial interpolation and clumps for the bangs](https://www.youtube.com/watch?v=5CHJX1HlUto&list=PLVn1U4WzCN31gIRUFf5fCoy4z-pyZydJM&index=3)

3. [Pony tail and hair band trick](https://www.youtube.com/watch?v=7sHuLOrbOzo&list=PLVn1U4WzCN31gIRUFf5fCoy4z-pyZydJM&index=4)

4. [Finishing the bangs](https://www.youtube.com/watch?v=F3rfnByVPOA&list=PLVn1U4WzCN31gIRUFf5fCoy4z-pyZydJM&index=5)
...
### Render fast tutorials

[5 Tips for FASTER 3D Rendering (Blender Cycles) - YouTub](https://www.youtube.com/watch?v=4NX2ubz8GW8)- *Downloaded* - Not exactly tips to increase Cycles speed, but techniques like multilayer, light groups and so…
...
5 Chapters - Very god tips, advices and overall info
...
### More on optimizing Renders

[Reducing Noise - Blender Manual](https://docs.blender.org/manual/en/latest/render/cycles/optimizations/reducing_noise.html)

[Shader Nodes - Blender Manual](https://docs.blender.org/manual/en/latest/render/cycles/optimizations/nodes.html)
...
### Tips about AgX and how to fine tune it (thread)
...
NOTE: DaVinci, but not related with Blender…
...
*Not specifically Blender - Maybe I could merge all the general Python info I have for Modo here?*
...
[A suite of concise explanations and examples covering vectors, rotors, and other things in 3D](https://x.com/endesga/status/1848252943553929291)

[Add-on Tutorial - Blender 4.1 Manual](https://docs.blender.org/manual/en/latest/advanced/scripting/addon_tutorial.html) (including a “Your First Add-on” section)

[Algorithmic Trees / Amit Sch | Observable](https://observablehq.com/@meetamit/algo-trees) - Also, to create procedural trees

[Blender Python - Scripting Series - YouTube](https://www.youtube.com/playlist?list=PLFtLHTf5bnym_wk4DcYIMq1DkjqB7kDb-) - Darkfall, “Learn Blender Python for Beginners” - [Blender Python Tutorial : Shortcut / Custom Keymap [learn python for beginners]](https://www.youtube.com/watch?v=0xBhh47Tblc&t=378s)

[CG Python Academy](https://www.skool.com/cgpython) - 3D artists learning Blender Python.
...
[Creative Coding in Blender 2.92: A Primer | by Jeremy Behreandt | Medium](https://behreajj.medium.com/creative-coding-in-blender-2-92-a-primer-7ac1b6fec3f)
...
[GitHub - Pullusb/How_to_install_Blender_addons: How to install Blender addons - the complete guide](https://github.com/Pullusb/How_to_install_Blender_addons)
...
[How to Derive the Equations of 3D Surfaces of Arbitrary Complexity and Model Them in Blender](https://www.youtube.com/watch?v=W4ViqzbF96Q) - Covers first the math approach, and then how to implement in Blender

[Lidia Martinez - Matemáticas para programadores](https://www.lidia-martinez.com/matesvectores/index.html)

[Scripting for Artists](https://studio.blender.org/training/scripting-for-artists/) - Blender Studio
...
>NOTE: finally included in Blender 5.2!!!

Creating a new super-bevel node for Blender - Journey and work diary by Howard Trickey
...
[C4D + Modo -> Blender - Basic Dummy Questions - Support / Other Software - Blender Artists Community](https://blenderartists.org/t/c4d-modo-blender-basic-dummy-questions/1407353)

[For Modo user switching to Blender 2.8 - General Forums / Blender Development Discussion - Blender Artists Community](https://blenderartists.org/t/for-modo-user-switching-to-blender-2-8/1145429)

[Modo to Blender modeling questions - Support / Modeling - Blender Artists Community](https://blenderartists.org/t/modo-to-blender-modeling-questions/1274186)
